          ...
          <div className="md:w-1/2">
            ...
            <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-600">
              ...
              <ul className="list-disc pl-5 text-gray-700 space-y-2">
                ...
                <li>Hỗ trợ kỹ thuật 24/7. Giao dịch bằng AI lượng tử từ thứ 2 - thứ 5 hàng tuần. Tái đầu tư để nhận lãi kép hàng ngày (không mất phí). Rút lợi nhuận/vốn vào những ngày cuối tuần (Thứ 7 & Chủ nhật). Tiền về ví cá nhân/ví sàn OTC trong 1 - 3 ngày, thường là 24h</li>
              </ul>
            </div>
          </div>
        </div>
