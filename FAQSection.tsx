...
const FAQSection: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Mức đầu tư tối thiểu là 100 USD, với mức này bạn có thể bắt đầu nhận lợi nhuận từ hệ thống giao dịch AI. Tuy nhiên, chúng tôi khuyến nghị mức đầu tư 10.000 USD để tối ưu lợi nhuận, với thu nhập ước tính khoảng 720 USD/tháng (bao gồm cả chia sẻ lợi nhuận và chia sẻ lot giao dịch)."
    },
    {
    ...
    },
    {
      ...
      answer: "Tỷ lệ giao dịch định lượng hàng tháng của AGA AI dự kiến sẽ nằm trong khoảng từ 3% đến 8% hoặc nhiều hơn. Ngoài ra, bạn còn nhận được thu nhập từ chia sẻ lot giao dịch, tùy thuộc vào mức đầu tư của bạn (từ 0,25 USD đến 0,30 USD/lot)."
    },
    {
